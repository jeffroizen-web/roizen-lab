...
- **Last touched**: 2026-06-27 (background-dispatch #3 wcag-a11y-pass DONE: fixed CTA-button + nav-hover contrast (white-on-gold 2.42:1 FAIL → purple-on-gold 5.39:1) + tests/test_contrast.py, committed 6ef972c local; 32 tests green. #1 site-qa-expand (9d0bfd1) + #2 templatize-content (a3a91cc) also done. Hosting still the one go-live gate.)
