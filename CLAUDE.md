...
- **Last touched**: 2026-07-01 (web-quality PR-1 DONE: design-tokens.css (canonical-seed type/spacing/radius/shadow/motion scales) + 287 token replacements in HTML + tokenized wire_letter_writers STYLE_BLOCK + tests/test_design_tokens.py, committed d607729 local; 54 green + screenshot-verified. Prior: self-assessment (015ab75), font-perf-fix (57dbac0), wcag-a11y (6ef972c), templatize (a3a91cc), site-qa-expand (9d0bfd1). Hosting still the one go-live gate. NEXT: web-quality PR-2 (image modernization webp/avif).)
